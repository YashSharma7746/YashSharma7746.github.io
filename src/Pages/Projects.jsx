...
const project = [
  {
    img: surveymonkey,
    title: "Survey Monkey",
    description: ["An online platform for creating different kinds of surveys","User can create Questions and different kind of Options for answers"],
  ...
  },
  {
    img: bigbasket,
    title: "Big Basket",
    description: ["An online daily grocery purhcasing website","User can Login or Signup","User can Checkout","Payment through Razorpay"],
    techStack: ["html","css","javascript","reactjs","redux","chakraui"],
  ...
  },
  {
    img: toggltrack,
    title: "Toogl Track",
    description: ["An online platform for tracking daily tasks and activities","User can create a schedule according to his convenience","Track his/her daily tasks"],
  ...
  },
  {
    img: beautybebo,
    title: "Beauty Bebo",
    description: ["An online cosmetics purhcasing website","User can Login or Signup"],
    techStack: ["html","css","javascript"],
      ...
      <Box>
        {project.map((project)=>{
          return <Box w={{base:"90%","2xl":"70%"}} key={project.title} m="auto" boxShadow="rgba(89, 4, 168, 0.137) 4px 5px 4px 3px !important" mt="40px" border={"1.7px solid rgba(200, 137, 230, 0.635)"} p="20px" >
            ...
            <Box p="20px">
              <Heading size="lg" color="#CD5FF8">{project.title}</Heading>
              {project.description.map((desc)=>{
                return <Box textAlign={"left"} key={desc} >
                    <li style={{cursor:"pointer",listStyle:"none",display:"flex",gap:"10px",marginTop:"15px",alignItems:"center",fontSize:"20px"}}><TfiHandPointRight/>{desc}</li>
                  </Box>
              })}
              <Box mt="20px" >
                <Link href={project.demo} mr="30px" isExternal textDecoration={"none"}>
                  <Button backgroundColor={"#CD5FF8"} colorScheme="transperent"><CgLink style={{marginRight:"10px"}}/>Live</Button>
                </Link>
                <Link href={project.github} isExternal>
                  <Button backgroundColor={"#CD5FF8"} colorScheme="transperent"><AiFillGithub style={{marginRight:"10px"}} />Git Hub</Button>
                </Link>
              </Box>
            </Box>
            </Box>
